...
import Learn, { fetchCategories, fetchArticles } from "../views/learn/learn";
import renderer from "react-test-renderer";
import categoryData from "../views/learn/categories.json";
import backendData from "../views/learn/mockData.json";
...
it("renders ensures that fetch unique categories functions for a mock data", () => {
  const returnedData = fetchCategories(backendData);
